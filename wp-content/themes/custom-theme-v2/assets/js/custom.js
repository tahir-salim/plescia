...
$(".projects-about").slick({
    ...
    speed: 300,
    slidesToShow: 3,
    prevArrow: '<a href="javascript:;" class="arrow-btn-1 left"><i class="fal fa-long-arrow-left"></i></a>',
    nextArrow: '<a href="javascript:;" class="arrow-btn-1 right"><i class="fal fa-long-arrow-right"></i></a>',
    responsive: [
        {
            breakpoint: 1025,
            settings: {
...
$(".plescia-projects").slick({
    ...
    $(".plescia-locations").slick({
        ...
        speed: 300,
        slidesToShow: 1,
        prevArrow: '<a href="javascript:;" class="arrow-btn-1 left"><img src="assets/images/btn-prev.png" /></a>',
        nextArrow: '<a href="javascript:;" class="arrow-btn-1 right"><img src="assets/images/btn-next.png" /></a>',
        responsive: [
            {
                breakpoint: 1025,
                settings: {
