...
<body <?php body_class(); ?>>
    ...
    <main>
        ...
        <div class="innerbanner" style="background-image: url(<?php echo $banner_section['image'];?>);">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="innerbanner-content">
                            <h1 class="wow fadeInUp" data-wow-delay="0.2s"><?php echo $banner_section['heading'];?></h1>
                            <h6 class="sub-heading wow fadeInUp mt-2" data-wow-delay="0.2s"><?php echo $banner_section['sub_heading'];?>
                            </h6>
